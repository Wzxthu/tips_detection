...
def load_dataset():
    ...
    X_train, X_val = X_data[l//4+1:], X_data[:l//4]
    y_train, y_val = Y_data[l//4+1:], Y_data[:l//4]
...
def build_mlp(input_var=None):
    ...
    l_in = lasagne.layers.InputLayer(shape=(None, 10, 10, 20),
                                     input_var=input_var)
...
def build_custom_mlp(input_var=None, depth=2, width=800, drop_input=.2,
    ...
    network = lasagne.layers.InputLayer(shape=(None, 10, 10, 20),
                                        input_var=input_var)
    if drop_input:
